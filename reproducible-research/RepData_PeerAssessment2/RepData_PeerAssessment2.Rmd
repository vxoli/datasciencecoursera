...
topEconomic <- sort(tapply(data$PROPDMG+data$CROPDMG, data$EVTYPE, FUN=sum), decreasing = TRUE)

d_econ <- as.data.frame(x = topEconomic, group=names(topEconomic))
```
